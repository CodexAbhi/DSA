...
- [ ] [Candy](https://leetcode.com/problems/candy/) — Hard
- [ ] [Jump Game II](https://leetcode.com/problems/jump-game-ii/) — Medium/Hard
...
- [ ] [Check Inclusion](https://leetcode.com/problems/permutation-in-string/) — Medium
- [ ] [Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring/) — Hard (Mid-level conceptually)
...
- [ ] [Decode Ways](https://leetcode.com/problems/decode-ways/) — Medium/Hard
- [ ] [Decode String](https://leetcode.com/problems/decode-string/) — Medium (recursive pattern)
...
- [ ] [Count Palindromic Substrings](https://leetcode.com/problems/palindromic-substrings/) — Medium
...
### Advanced
- [ ] [Wiggle Sort II](https://leetcode.com/problems/wiggle-sort-ii/) — Medium/Hard
- [ ] [Maximum Gap](https://leetcode.com/problems/maximum-gap/) — Hard
- [ ] [Create Maximum Number](https://leetcode.com/problems/create-maximum-number/) — Hard
- [ ] [Minimum Number of Arrows to Burst Balloons](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/) — Medium/Hard
...
- [ ] [Intersection of Two Linked Lists](https://leetcode.com/problems/intersection-of-two-linked-lists/) — Easy/Medium
...
- [ ] [LRU Cache](https://leetcode.com/problems/lru-cache/) — Medium/Hard
- [ ] [Sort List](https://leetcode.com/problems/sort-list/) — Medium/Hard
- [ ] [Reorder List](https://leetcode.com/problems/reorder-list/) — Medium/Hard
- [ ] [Flatten a Multilevel Doubly Linked List](https://leetcode.com/problems/flatten-a-multilevel-doubly-linked-list/) — Medium
- [ ] [Linked List in Binary Tree](https://leetcode.com/problems/linked-list-in-binary-tree/) — Medium/Hard
...
- [ ] [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/) — Hard
- [ ] [Basic Calculator](https://leetcode.com/problems/basic-calculator/) — Hard
- [ ] [Basic Calculator II](https://leetcode.com/problems/basic-calculator-ii/) — Medium/Hard
...
- [ ] [Longest Harmonious Subsequence](https://leetcode.com/problems/longest-harmonious-subsequence/) — Easy/Medium
- [ ] [Find All Anagrams in a String](https://leetcode.com/problems/find-all-anagrams-in-a-string/) — Medium
- [ ] [Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) — Medium
- [ ] [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/) — Easy/Medium
...
- [ ] [Alien Dictionary](https://leetcode.com/problems/alien-dictionary/) — Hard (hashing + graph)
- [ ] [Evaluate Division](https://leetcode.com/problems/evaluate-division/) — Medium/Hard
...
- [ ] [Path Sum](https://leetcode.com/problems/path-sum/) — Easy (intro to recursion)

### Intermediate
- [ ] [Path Sum II](https://leetcode.com/problems/path-sum-ii/) — Medium
- [ ] [Word Search](https://leetcode.com/problems/word-search/) — Medium
- [ ] [Word Search II](https://leetcode.com/problems/word-search-ii/) — Hard (Trie synergy)
...
- [ ] [Matchsticks to Square](https://leetcode.com/problems/matchsticks-to-square/) — Medium/Hard
...
- [ ] [The Maze](https://leetcode.com/problems/the-maze/) — Medium/Hard
- [ ] [The Maze II](https://leetcode.com/problems/the-maze-ii/) — Medium/Hard
- [ ] [The Maze III](https://leetcode.com/problems/the-maze-iii/) — Hard
- [ ] [Android Unlock Patterns](https://leetcode.com/problems/android-unlock-patterns/) — Hard
- [ ] [Word Break II](https://leetcode.com/problems/word-break-ii/) — Hard
- [ ] [Generalized Abbreviation](https://leetcode.com/problems/generalized-abbreviation/) — Medium/Hard
...
- [ ] [Right Side View](https://leetcode.com/problems/binary-tree-right-side-view/) — Medium
- [ ] [Left Side View](https://leetcode.com/problems/symmetric-tree/) — Medium (variation)
...
- [ ] [Binary Tree Tilt](https://leetcode.com/problems/binary-tree-tilt/) — Easy/Medium
...
- [ ] [Binary Tree Coloring Game](https://leetcode.com/problems/binary-tree-coloring-game/) — Medium/Hard
- [ ] [Smallest Subtree with All the Deepest Nodes](https://leetcode.com/problems/smallest-subtree-with-all-the-deepest-nodes/) — Medium/Hard
...
- [ ] [Boundary of Binary Tree](https://leetcode.com/problems/boundary-of-binary-tree/) — Hard
- [ ] [All Nodes Distance K in Binary Tree](https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree/) — Medium/Hard
- [ ] [Vertical Order Traversal of a Binary Tree](https://leetcode.com/problems/vertical-order-traversal-of-a-binary-tree/) — Hard
- [ ] [Binary Tree Vertical Order Traversal](https://leetcode.com/problems/binary-tree-vertical-order-traversal/) — Medium/Hard
- [ ] [Construct Quad Tree](https://leetcode.com/problems/construct-quad-tree/) — Medium/Hard
- [ ] [Longest Zigzag Path in a Tree](https://leetcode.com/problems/longest-zigzag-path-in-a-tree/) — Medium/Hard
- [ ] [Pseudo-Palindromic Paths in a Binary Tree](https://leetcode.com/problems/pseudo-palindromic-paths-in-a-binary-tree/) — Medium/Hard
- [ ] [Path Sum III](https://leetcode.com/problems/path-sum-iii/) — Medium/Hard
...
- [ ] [Delete Node in a BST](https://leetcode.com/problems/delete-node-in-a-binary-search-tree/) — Medium
...
- [ ] [Balanced BST (Convert Sorted Array to BST)](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/) — Easy/Medium
- [ ] [Two Sum IV - Input is a BST](https://leetcode.com/problems/two-sum-iv-input-is-a-bst/) — Easy/Medium
- [ ] [Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) — Medium
- [ ] [BST Iterator](https://leetcode.com/problems/binary-search-tree-iterator/) — Medium

### Advanced
- [ ] [Construct BST from Preorder Traversal](https://leetcode.com/problems/construct-binary-search-tree-from-preorder-traversal/) — Medium/Hard
- [ ] [Recover Binary Search Tree](https://leetcode.com/problems/recover-binary-search-tree/) — Hard
- [ ] [Lowest Common Ancestor of a BST](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) — Easy/Medium
- [ ] [Inorder Successor in BST](https://leetcode.com/problems/inorder-successor-in-bst/) — Medium
- [ ] [Closest Binary Search Tree Value](https://leetcode.com/problems/closest-binary-search-tree-value/) — Easy/Medium
- [ ] [Closest K Values in a BST](https://leetcode.com/problems/closest-binary-search-tree-value-ii/) — Hard
- [ ] [Unique Binary Search Trees](https://leetcode.com/problems/unique-binary-search-trees/) — Medium
- [ ] [Unique Binary Search Trees II](https://leetcode.com/problems/unique-binary-search-trees-ii/) — Medium/Hard
- [ ] [Trim a Binary Search Tree](https://leetcode.com/problems/trim-a-binary-search-tree/) — Medium
- [ ] [Serialize and Deserialize BST](https://leetcode.com/problems/serialize-and-deserialize-bst/) — Medium/Hard
...
### Intermediate (Topo Sort / Multi-source BFS / Union-Find)
...
- [ ] [Friend Circles / Number of Provinces](https://leetcode.com/problems/number-of-provinces/) — Medium
- [ ] [Accounts Merge](https://leetcode.com/problems/accounts-merge/) — Medium
- [ ] [Graph Valid Tree](https://leetcode.com/problems/graph-valid-tree/) — Medium

### Intermediate (Shortest Path / BFS Variants)
...
### Advanced (Dijkstra / Bellman-Ford / Complex BFS)
- [ ] [Cheapest Flights Within K Stops](https://leetcode.com/problems/cheapest-flights-within-k-stops/) — Medium
- [ ] [Swim in Rising Water](https://leetcode.com/problems/swim-in-rising-water/) — Hard
- [ ] [Path With Minimum Effort](https://leetcode.com/problems/path-with-minimum-effort/) — Medium/Hard
...
- [ ] [Critical Connections in a Network](https://leetcode.com/problems/critical-connections-in-a-network/) — Hard (Tarjan’s Algo)
- [ ] [Minimum Cost to Connect Points](https://leetcode.com/problems/min-cost-to-connect-all-points/) — Medium (MST / Prim’s)
- [ ] [Regions Cut By Slashes](https://leetcode.com/problems/regions-cut-by-slashes/) — Medium (Union-Find)
- [ ] [Evaluate Division](https://leetcode.com/problems/evaluate-division/) — Medium
- [ ] [Find Eventual Safe States](https://leetcode.com/problems/find-eventual-safe-states/) — Medium
- [ ] [Pacific Atlantic Water Flow](https://leetcode.com/problems/pacific-atlantic-water-flow/) — Medium
- [ ] [Detect Cycles in 2D Grid](https://leetcode.com/problems/detect-cycles-in-2d-grid/) — Medium/Hard

### Very Advanced (Top-tier interview problems)
- [ ] [Shortest Bridge](https://leetcode.com/problems/shortest-bridge/) — Medium/Hard
- [ ] [Escape a Large Maze](https://leetcode.com/problems/escape-a-large-maze/) — Hard
...
- [ ] [Find Smallest Letter Greater Than Target](https://leetcode.com/problems/find-smallest-letter-greater-than-target/) — Easy/Medium
...
- [ ] [Book Allocation Problem (LC Variant: Capacity to Ship Packages)](https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/) — Medium/Hard
- [ ] [Aggressive Cows Variant (Magnetic Force)](https://leetcode.com/problems/magnetic-force-between-two-balls/) — Medium/Hard
- [ ] [Minimize Max Distance to Gas Station](https://leetcode.com/problems/minimize-max-distance-to-gas-station/) — Hard
- [ ] [Find Right Interval](https://leetcode.com/problems/find-right-interval/) — Medium/Hard
...
- [ ] [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/) — Hard (but pointer logic)
- [ ] [Remove Nth Node From End of List](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) — Medium
- [ ] [Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) — Medium
- [ ] [Longest Repeating Character Replacement](https://leetcode.com/problems/longest-repeating-character-replacement/) — Medium
...
- [ ] [Longest Continuous Increasing Subsequence](https://leetcode.com/problems/longest-continuous-increasing-subsequence/) — Easy/Medium
...
- [ ] [Shortest Subarray with Sum at Least K](https://leetcode.com/problems/shortest-subarray-with-sum-at-least-k/) — Hard
- [ ] [Maximize the Confusion of an Exam](https://leetcode.com/problems/maximize-the-confusion-of-an-exam/) — Medium/Hard
- [ ] [Jump Game II](https://leetcode.com/problems/jump-game-ii/) — Medium/Hard
...
- [ ] [Max Sliding Window Using Deque](https://leetcode.com/problems/sliding-window-maximum/) — Hard
- [ ] [Longest Subarray of 1's After Deleting One Element](https://leetcode.com/problems/longest-subarray-of-1s-after-deleting-one-element/) — Medium/Hard
- [ ] [Find Pivot Index](https://leetcode.com/problems/find-pivot-index/) — Easy/Medium
- [ ] [Monotonic Array](https://leetcode.com/problems/monotonic-array/) — Easy/Medium
...
- [ ] [Maximum Subarray](https://leetcode.com/problems/maximum-subarray/) — Easy (Kadane’s)
...
- [ ] [Split Array into Consecutive Subsequences](https://leetcode.com/problems/split-array-into-consecutive-subsequences/) — Medium/Hard
- [ ] [Bag of Tokens](https://leetcode.com/problems/bag-of-tokens/) — Medium
- [ ] [Min Cost Climbing Stairs](https://leetcode.com/problems/min-cost-climbing-stairs/) — Easy/Medium

### Advanced
- [ ] [Candy](https://leetcode.com/problems/candy/) — Hard
- [ ] [Create Maximum Number](https://leetcode.com/problems/create-maximum-number/) — Hard
- [ ] [Patching Array](https://leetcode.com/problems/patching-array/) — Hard
- [ ] [Minimum Deletions to Make Character Frequencies Unique](https://leetcode.com/problems/minimum-deletions-to-make-character-frequencies-unique/) — Medium/Hard
- [ ] [Stone Game](https://leetcode.com/problems/stone-game/) — Medium/Hard
- [ ] [Stone Game II](https://leetcode.com/problems/stone-game-ii/) — Medium/Hard
- [ ] [Stone Game VII](https://leetcode.com/problems/stone-game-vii/) — Hard
- [ ] [Find the Minimum Number of Fibonacci Numbers Whose Sum Is K](https://leetcode.com/problems/find-the-minimum-number-of-fibonacci-numbers-whose-sum-is-k/) — Medium/Hard
...
### Intermediate (Knapsack-style DP)
...
### DP on Strings (Subsequence / Edit Distance)
...
- [ ] [Regular Expression Matching](https://leetcode.com/problems/regular-expression-matching/) — Hard
- [ ] [Wildcard Matching](https://leetcode.com/problems/wildcard-matching/) — Hard
- [ ] [Interleaving String](https://leetcode.com/problems/interleaving-string/) — Medium/Hard
...
- [ ] [00 Matrix](https://leetcode.com/problems/01-matrix/) — Medium
- [ ] [Out of Boundary Paths](https://leetcode.com/problems/out-of-boundary-paths/) — Medium/Hard
- [ ] [Minimum Falling Path Sum](https://leetcode.com/problems/minimum-falling-path-sum/) — Medium

### Advanced DP (Tree DP / Bitmask DP / Hard Optimization)
- [ ] [Binary Tree Maximum Path Sum](https://leetcode.com/problems/binary-tree-maximum-path-sum/) — Hard
- [ ] [Minimum Score Triangulation of Polygon](https://leetcode.com/problems/minimum-score-triangulation-of-polygon/) — Medium/Hard
...
- [ ] [Number of Ways to Arrive at Destination](https://leetcode.com/problems/number-of-ways-to-arrive-at-destination/) — Medium/Hard
...
- [ ] [Minimum Time to Make Rope Colorful](https://leetcode.com/problems/minimum-time-to-make-rope-colorful/) — Medium
- [ ] [Count Vowel Permutation](https://leetcode.com/problems/count-vowel-permutation/) — Hard
...
- [ ] [Longest Word in Dictionary](https://leetcode.com/problems/longest-word-in-dictionary/) — Easy/Medium
...
- [ ] [Implement Magic Dictionary](https://leetcode.com/problems/implement-magic-dictionary/) — Medium/Hard
- [ ] [Longest Duplicate Substring](https://leetcode.com/problems/longest-duplicate-substring/) — Hard
- [ ] [Word Break II (Trie-optimized variant)](https://leetcode.com/problems/word-break-ii/) — Hard

---

## Advanced Strings

### Basics (Pattern Matching Foundations)
- [ ] [Implement strStr() (KMP optional)](https://leetcode.com/problems/implement-strstr/) — Easy
- [ ] [Repeated Substring Pattern](https://leetcode.com/problems/repeated-substring-pattern/) — Easy/Medium
- [ ] [Is Subsequence](https://leetcode.com/problems/is-subsequence/) — Easy

### Intermediate (KMP / Z-algorithm / Rolling Hash)
- [ ] [Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring/) — Medium
- [ ] [Find All Anagrams in a String](https://leetcode.com/problems/find-all-anagrams-in-a-string/) — Medium
- [ ] [Permutation in String](https://leetcode.com/problems/permutation-in-string/) — Medium
- [ ] [Longest Common Prefix](https://leetcode.com/problems/longest-common-prefix/) — Easy
- [ ] [Count and Say](https://leetcode.com/problems/count-and-say/) — Medium
- [ ] [Find the Index of the First Occurrence in a String (KMP thinking)](https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/) — Easy/Medium
- [ ] [Repeated DNA Sequences](https://leetcode.com/problems/repeated-dna-sequences/) — Medium (Rolling Hash)

### Advanced (DP + String Algorithms)
- [ ] [Wildcard Matching](https://leetcode.com/problems/wildcard-matching/) — Hard
- [ ] [Regular Expression Matching](https://leetcode.com/problems/regular-expression-matching/) — Hard
- [ ] [Longest Duplicate Substring](https://leetcode.com/problems/longest-duplicate-substring/) — Hard (Suffix Array / Binary Search + Hash)
- [ ] [Shortest Palindrome](https://leetcode.com/problems/shortest-palindrome/) — Hard (KMP)
- [ ] [Palindromic Substrings](https://leetcode.com/problems/palindromic-substrings/) — Medium
- [ ] [Longest Palindromic Subsequence](https://leetcode.com/problems/longest-palindromic-subsequence/) — Medium
- [ ] [Convert to Palindrome With One Deletion](https://leetcode.com/problems/valid-palindrome-ii/) — Easy/Medium
...
### Basics (Number Theory & Bit Fundamentals)
...
- [ ] [Counting Bits](https://leetcode.com/problems/counting-bits/) — Easy/Medium
...
### Intermediate (Math / Bitmask / Combinatorics)
- [ ] [Sum of Two Integers](https://leetcode.com/problems/sum-of-two-integers/) — Medium
- [ ] [Missing Number](https://leetcode.com/problems/missing-number/) — Easy/Medium
- [ ] [Perfect Squares](https://leetcode.com/problems/perfect-squares/) — Medium
- [ ] [Happy Number](https://leetcode.com/problems/happy-number/) — Easy/Medium
- [ ] [Factorial Trailing Zeroes](https://leetcode.com/problems/factorial-trailing-zeroes/) — Medium

### Advanced (Bitmask DP / Hard Math)
- [ ] [Maximum XOR of Two Numbers in an Array](https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array/) — Medium/Hard
- [ ] [Maximum XOR With an Element From Array](https://leetcode.com/problems/maximum-xor-with-an-element-from-array/) — Hard
- [ ] [Total Hamming Distance](https://leetcode.com/problems/total-hamming-distance/) — Hard
- [ ] [Prime Number of Set Bits in Binary Representation](https://leetcode.com/problems/prime-number-of-set-bits-in-binary-representation/) — Easy/Medium
- [ ] [Smallest Integer Divisible by K](https://leetcode.com/problems/smallest-integer-divisible-by-k/) — Hard
